...
class NingApi {
    ...
    public $subdomain = 'http://sourcingadda.ning.com/blog';
    // Ning user email address
    protected $email = 'yusuf@certifiedsourcingpro.com';
    // Ning user password
    protected $password = 'sourcepro';
    // Consumer key found at [subdomain].ning.com/main/extend/keys
    protected $consumerKey = '0d716e57-5ada-4b29-a33c-2f4af1b26837';
    // Consumer secret found at [subdomain].ning.com/main/extend/keys
    protected $consumerSecret = 'f0963fa5-1259-434f-86fc-8a17d14b16ca';
