...
<script src="js/jquery-1.4.2.min.js" type="text/javascript"></script>
  ...
  <script>
	...
	$(document).ready(function(){ 
		$('#submit').click(function(){
			...
			$.ajax({
			   type: "POST",
			   url: "http://certifiedsourcingpro.com/version1.2/registration_submit_free.php",
			   data: var_form_data, 
			   dataType: 'html',
			   ...
			   success: function(data){
				...
				if(data==1)
				{
					$("#success").html('Thank You for Registration & Please check your mail.');
  ...
  <!--For Ajax Dropdown value change-->
  <!--<script>
  ...
  <div id="content">		
     ...
     <div class="formtext">
        ...
        <div class="col-3">
                ...
                <div class="col-1">
                <form action="registration_submit_free.php" id="form2" name="form2" method="post" novalidate="novalidate">
       	            <div class="container1">
                   First Name*
           	              <div class="h">
           	                <input  type="text"  id="first_name" name="first_name"  value=""  this.value=''  />
 							&nbsp;<span id="msg_first_name" style="color:#F00; margin-left:112px;"></span>
      	                  </div>
                               E-mail*   	              
                           <div class="h">
           	                <input  type="text" id="email_address" name="email_address" value=""  this.value=''  />
       	                    &nbsp;<span id="msg_email_address" style="color:#F00; margin-left:112px;"></span>   
                          </div>
                            Company Name*      	              
                           <div class="h">
           	                <input  type="text" id="company_name"  name="company_name" value=""  this.value='' />
       	                 &nbsp;<span id="msg_company_name" style="color:#F00; margin-left:112px;"></span>
                          </div>
                          
                            Position        	              
                            <div class="h">
           	                <input type="text" id="position"  name="position" value=""  this.value=''  />
       	                  &nbsp;<span id="msg_position" style="color:#F00; margin-left:112px;"></span>
                          </div>
...
<?php /*?><select id="t_date" name="t_date" >
                	...
                	<div class="indent">
       	            ...
       	            <div class="container1">
                         Last Name*
       	                  ...
       	                  &nbsp;<span id="msg_last_name" style="color:#F00; margin-left:112px;"></span>
                          </div>
                      Contact Number*
           	              <div class="h">
           	                <input  type="text" id="contact_no"  name="contact_no" value=""  this.value='' />
       	                    &nbsp;<span id="msg_contact_no" style="color:#F00; margin-left:112px;"></span>
                          </div>
                           Location
                           <div class="h">
						<input  type="text" id="location"  name="location" value="" this.value='' />
       	                 &nbsp;<span id="msg_location" style="color:#F00; margin-left:112px;"></span>
							</div>
  ...
  <option value="4" <?php $m=$_GET['m'];if($m==4){echo 'selected=selected';}?>>HeadhuntPro</option>
             ...
             <!--For Ajax Message--><div id="success" style="color:#F00;"></div><!--For Ajax Message-->          
