	...
	$(document).ready(function(){ 
		$('#submit').click(function(){
			...
			myValues[$(this).attr('first_name')] = $(this).val();
				...
				/*$.ajax({
				   type: "POST",
				   url: "http://certifiedsourcingpro.com/version1.2/registration_submit.php",
				   data: var_form_data, 
				   dataType: 'html',
				   ...
				   success: function(data){
					...
					if(data==1)
					{
						$("#success").html('Record added successfully.');
					
					}else if(data==0) {
						
						$("#success").html('Record updated successfully.');
					 }
...
<!--For Ajax-->
  <script>
		function changeSecond(objVs){	
			$.ajax({
			   type: "POST",
			   url: "http://certifiedsourcingpro.com/version1.2/moduleData.php",
			   data: "pro_module="+objVs+"&matchfn="+Math.random(), 
			   dataType: 'html',
			   success: function(data){
				//alert(objVs);
				$("#mod").html(data);
...
-->            </ul>            
  ...
  <div id="content">		
        ...
        <div class="col-3"><h2> Registration </h2>
...
<?php /*?><select id="t_date" name="t_date" >
  <option  value="2014-05-13" <?php $d=$_GET['d'];if($d=="2014-05-13"){echo 'selected=selected';} ?>>13-05-2014</option>
  <option  value="2014-05-14" <?php $d=$_GET['d'];if($d=="2014-05-14"){echo 'selected=selected';} ?>>14-05-2014</option>
  <option  value="2014-05-15" <?php $d=$_GET['d'];if($d=="2014-05-15"){echo 'selected=selected';} ?>>15-05-2014</option>
  <option  value="2014-05-16" <?php $d=$_GET['d'];if($d=="2014-05-16"){echo 'selected=selected';} ?>>16-05-2014</option>
  
  <option value="2014-05-27" <?php $d=$_GET['d'];if($d=="2014-05-27"){echo 'selected=selected';} ?>>27-05-2014</option>
  <option value="2014-05-28" <?php $d=$_GET['d'];if($d=="2014-05-28"){echo 'selected=selected';} ?>>28-05-2014</option>
  <option value="2014-05-29" <?php $d=$_GET['d'];if($d=="2014-05-29"){echo 'selected=selected';} ?>>29-05-2014</option>
  <option value="2014-05-30" <?php $d=$_GET['d'];if($d=="2014-05-30"){echo 'selected=selected';} ?>>30-05-2014</option>

  <option value="2014-06-17" <?php $d=$_GET['d'];if($d=="2014-06-17"){echo 'selected=selected';} ?>>17-06-2014</option>
  <option value="2014-06-18" <?php $d=$_GET['d'];if($d=="2014-06-18"){echo 'selected=selected';} ?>>18-06-2014</option>
  <option value="2014-06-19" <?php $d=$_GET['d'];if($d=="2014-06-19"){echo 'selected=selected';} ?>>19-06-2014</option>
  <option value="2014-06-20" <?php $d=$_GET['d'];if($d=="2014-06-20"){echo 'selected=selected';} ?>>20-06-2014</option>
  ...
  <?php /*?> <?php 
  $array_main = array(
                    1 => array("BasicPro" => array("2014-05-13","2014-05-27","2014-06-17")),
                      2 => array("ResearchPro" => array("2014-05-14","2014-05-28","2014-06-18")),
                     3 => array("SocialPro" => array("2014-05-15","2014-05-29","2014-06-19")),
				   4 =>array("HeadhuntPro" => array("2014-05-16","2014-05-30","2014-06-20"))
                     ); 
	$module = $_GET['m'];
	if(!$module) {return false;
	}else 
	{
		$array_state = $array_main[$module];
